...
Copyright 2012 - 2020  Charleston Software Associates (info@storelocatorplus.com). All rights reserved worldwide.
...
defined( 'SLPLUS_VERSION'  ) || define( 'SLPLUS_VERSION'  , '5.5.9' );
