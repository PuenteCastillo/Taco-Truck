  ...
  $output=sprintf($html,
    ...
    public function admin_notice_for_elementor_addon(){
        if( !current_user_can( 'update_plugins' ) ){
         ...
         $output='';
         $output='<div class="ele_addon_notice_wrp notice notice-info is-dismissible"><a href="https://wordpress.org/plugins/timeline-widget-addon-for-elementor/">
         
         <div class="logo_container"><img src="'.$ele_logo.'"></a>
         </div>
         <div  class="message_container">
          Hi! We checked that you are using <strong>Elementor Page Builder</strong>.
          <br/>Please try latest <a href="https://wordpress.org/plugins/timeline-widget-addon-for-elementor/"><strong>Elementor Timeline Widget Addon</strong></a> plugin developed by <a href="https://coolplugins.net">Cool Plugins</a> & showcase your life story or company history in a beautiful timeline design.
         </div>
          </div><style>
